...
/*********************************************************************
 * @fn      USBD_GetConfiguration.
 *
 * @brief   Get the device state from configured.
 *
 * @return  none
 */
__attribute__((weak)) void USBD_GetConfiguration(void)
{
}
 ...
 * @return  none
 */
__attribute__((weak)) void USBD_SetConfiguration(void)
{
...
/*********************************************************************
 * @fn      USBD_GetInterface.
 *
 * @brief
 *
 * @return  none
 */
__attribute__((weak)) void USBD_GetInterface(void)
{
}

/*********************************************************************
 * @fn      USBD_SetInterface.
 *
 * @brief
 *
 * @return  none
 */
__attribute__((weak)) void USBD_SetInterface(void)
{
}
 ...
 * @return  none
 */
__attribute__((weak)) void USBD_GetStatus(void)
{
}

/*********************************************************************
 * @fn      USBD_SetEndPointFeature.
 *
 * @brief
 *
 * @return  none
 */
__attribute__((weak)) void USBD_SetEndPointFeature(void)
{
}
 ...
 * @return  none
 */
__attribute__((weak)) void USBD_SetDeviceAddress(void)
{
 ...
 * @return  none
 */
__attribute__((weak)) void USBD_SetDeviceFeature(void)
{
 ...
 * @return  none
 */
__attribute__((weak)) void USBD_ClearFeature(void)
{
    USBD_Sleep_Status &= ~0x01;
}
 ...
 * @return  none
 */
__attribute__((weak)) void USBD_Status_In(void)
{
    // uint16_t i;
    // if (Type_Recipient == (CLASS_REQUEST | INTERFACE_RECIPIENT)) {
    //     if (pInformation->USBbRequest == HID_SET_REPORT) {
    //         DUG_PRINTF("Set Report:\n");
    //         for (i = 0; i < 64; ++i) {
    //             DUG_PRINTF("%02x ", HID_Report_Buffer[i]);
    //         }
    //         DUG_PRINTF("\n");
    //     }
    // }
 ...
 * @return  none
 */
__attribute__((weak)) void USBD_Status_Out(void)
{
}
